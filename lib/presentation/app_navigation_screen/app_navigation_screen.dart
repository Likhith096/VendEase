                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Products page",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.productsPageScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Search Page",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.searchPageScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Carts page - Container",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.cartsPageContainerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Home",
